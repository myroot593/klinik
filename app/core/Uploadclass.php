...
class Uploadclass
{
	public function createImage($data=null, $path=null, $name=null)
	{
		...
		$this->file_item=(empty($name))?rand(100,1000000).".".$this->file_extension:$name.".".$this->file_extension;		
		$this->file_valid=array('jpg','jpeg','png','ico');
